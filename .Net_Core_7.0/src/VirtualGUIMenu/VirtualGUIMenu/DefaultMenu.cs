...
namespace VirtualGUIMenu
{
    ...
    public class DefaultMenu
    {
        ...
        /// <summary>
        ///     Prints the white text Menu
        /// </summary>
        /// <param name="choice"></param>
        private void PrintWithNoColor(int choice)
        {
            int width = new int();
            if (this.MinWidth != 0)
            {
        ...
        protected virtual void ReturnChoice(ref int choice, ref bool quit)
        {
            ...
            switch (k.Key)
            {
                ...
                // Default keys
                default:
                    Console.WriteLine("Up/Down, W/S, Enter/Esc only");
                    Console.ReadKey();
                    break;
            }
        }
        ...
        /// <summary>
        ///     Runs the white text menu
        /// </summary>
        /// <param name="choice"></param>
        /// <param name="menu"></param>
        /// <returns></returns>
        public int RunWithNoColor(int choice)
        {
            bool quit = false;
            do
            {
